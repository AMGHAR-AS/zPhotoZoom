...
export class zPhotoCarousel extends zPhotoZoom {
    constructor(options, context) {
        ...
        Object.defineProperty(this, "_carouselState", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_carouselOptions", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        // Components
        Object.defineProperty(this, "_thumbnailBar", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_keyboardNav", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "_swipeDetector", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_navigationArrows", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        // Event callbacks
        Object.defineProperty(this, "_navigateCallbacks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "_slideChangeCallbacks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        // UI elements
        Object.defineProperty(this, "_mainImageContainer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    createCarouselStructure() {
        ...
        const container = this._process.preview.container;
    ...
    setupCarouselComponents() {
        ...
        if (this._carouselOptions.enableArrows) {
            this._navigationArrows = new NavigationArrows(() => this.previous(), () => this.next(), this._carouselOptions.arrowPosition);
            this._mainImageContainer.appendChild(this._navigationArrows.render());
            this._navigationArrows.updateDisabledState(this._carouselState.currentIndex, this._carouselState.totalImages, this._carouselOptions.loop);
        }
        // Add counter
        if (this._carouselOptions.showCounter) {
            ...
            this._counter.update(this._carouselState.currentIndex + 1, this._carouselState.totalImages);
        }
        // Add thumbnail bar
    ...
    async displayImage(index, withTransition = true) {
        ...
        try {
            await transitionFn(currentImageNode, imageNode, direction, this._carouselOptions.transitionDuration, this._mainImageContainer);
        }
        catch (error) {
    ...
    updateUIComponents() {
        ...
        if (this._navigationArrows) {
            this._navigationArrows.updateDisabledState(index, this._carouselState.totalImages, this._carouselOptions.loop);
        }
    }
    /**
...
//# sourceMappingURL=zPhotoCarousel.js.map