...
export class zPhotoCarousel extends zPhotoZoom {
  ...
  private updateCurrentImage(image: ImageDataExtended): void {
    ...
    setTimeout(() => {
      // Calculate available space (accounting for thumbnail bar)
      ...
      this.process.currentImage = {
        ...
        center: {
          x: centerX,  // Use calculated center of available space
          y: centerY   // Use calculated center of available space
        },
        minScale: 0.3,
        maxScale: 5,
        x: 0,
